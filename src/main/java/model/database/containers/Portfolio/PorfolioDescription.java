...
public class PorfolioDescription implements Description {
    ...
    public PorfolioDescription(PortfolioPK uuid, String FK_UUID_User, String title, String commentary,
    ...
    public PorfolioDescription(PortfolioPK uuid, String FK_UUID_User, String title) {
        this.uuid = uuid;
        this.userDescription = getUserDescription(FK_UUID_User);
        this.title = title;
    }

    public PorfolioDescription(PortfolioPK uuid, String FK_UUID_User) {
        this.uuid = uuid;
        this.userDescription = getUserDescription(FK_UUID_User);
